...
urlpatterns = [
    ...
    path(
        "<int:project_id>/report/", ReportProjectView.as_view(), name="report_project"
    ),
    path(
        "<int:project_id>/cancel/", CancelProjectView.as_view(), name="cancel_project"
    ),
    ...
    path("blueprint/", blueprint, name="blueprint"),
]
