...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        if user_form.is_valid():
            ...
            user_object.email_confirmed = (
                False  # ~ Set user unverfied until email confirmation
            )
        ...
        if form.is_valid():
            ...
            if user is not None:
                if user.email_confirmed:
                    ...
                    return render(
                        request, "users/activation_failure.html", {"user": user}
                    )
            else:
                return render(
                    request,
...
class CustomPasswordResetView(View):
    def get(self, request):
        return render(
            request, "users/password_reset.html", {"form": PasswordResetForm()}
        )
    ...
    def get(self, request, uidb64, token):
        ...
        if user is not None and account_token.check_token(user, token):
            return render(
                ...
                {"form": SetPasswordForm(user), "valid_link": True},
            )
        return render(
            request, "users/password_reset_confirm.html", {"valid_link": False}
        )
        ...
        if user is not None and account_token.check_token(user, token):
            ...
            if form.is_valid():
                ...
                return render(
                    request,
                    "users/password_reset_confirm.html",
                    {"password_changed": True, "valid_link": True},
                )
            return render(
                request,
                "users/password_reset_confirm.html",
...
class CustomPasswordChangeView(View):
    def get(self, request):
        ...
        return render(
            ...
            {"form": form, "password_changed": False},
        )
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            return render(
                request,
                "users/password_change.html",
                {"form": None, "password_changed": True},
            )
        return render(
            request,
            "users/password_change.html",
...
class AdminDeleteProjectView(AdminRequiredMixin, View):
    def post(self, request, project_id):
        ...
        project.delete()
        messages.success(
            request, f"Project '{project_title}' has been successfully deleted."
        )
...
class AdminDeleteUserView(AdminRequiredMixin, View):
    def post(self, request, user_id):
        ...
        messages.success(
            request,
            f"User '{user_email}' has been successfully deleted along with all their projects and donations.",
        )
        return redirect("admin_dashboard")
...
class AdminDismissReportView(AdminRequiredMixin, View):
    def post(self, request, report_id):
        ...
        report.save()
        messages.success(
            request, f"Report on project '{report.project.title}' has been dismissed."
        )
        return redirect("admin_dashboard")
...
class AdminApproveCommentView(AdminRequiredMixin, View):
    def post(self, request, comment_id):
        ...
        comment.save()
        messages.success(
            request, f"Comment on project '{comment.project.title}' has been approved."
        )
        return redirect("admin_dashboard")
...
class AdminDeleteCommentView(AdminRequiredMixin, View):
    def post(self, request, comment_id):
        ...
        comment.delete()
        messages.success(
            request, f"Comment on project '{project_title}' has been deleted."
        )
        return redirect("admin_dashboard")
...
class AdminDeleteCategoryView(AdminRequiredMixin, View):
    def post(self, request, category_id):
        ...
        if category.projects.exists():
            messages.error(
                request,
                f"Cannot delete category '{category.name}' as it has associated projects.",
            )
            return redirect("admin_dashboard")
