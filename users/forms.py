...
class UserEditForm(forms.ModelForm):
    ...
    profile_picture = forms.ImageField(
        ...
        widget=forms.FileInput(
            attrs={"class": "form-control", "accept": "image/jpeg,image/png,image/gif"}
        ),
    )
...
class ProfileEditForm(forms.ModelForm):
    ...
    def clean_birthdate(self):
        ...
        if birthdate:
            ...
            min_age = 13
            age_threshold = timezone.now().date() - datetime.timedelta(
                days=min_age * 365
            )
            ...
            max_age = 120
            max_age_threshold = timezone.now().date() - datetime.timedelta(
                days=max_age * 365
            )
...
class UserRegistrationForm(forms.ModelForm):
    ...
    first_name = forms.CharField(
        validators=[MinLengthValidator(3, "First name must be at least 3 characters")],
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "placeholder": "Enter your first name",
    ...
    # Last name with length validation
    last_name = forms.CharField(
        validators=[MinLengthValidator(3, "Last name must be at least 3 characters")],
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "placeholder": "Enter your last name",
    ...
    # Enhanced phone number validation for Egyptian numbers
    phone_number = forms.CharField(
        required=False,
        validators=[
            RegexValidator(
